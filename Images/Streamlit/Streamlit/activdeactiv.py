...
if "is_button1_disabled" not in st.session_state:
    st.session_state.is_button1_disabled = False
...
with col1:
    ...
    if st.button("Button 1", key="button1", disabled=st.session_state.is_button1_disabled):
        st.session_state.is_button1_disabled = True
        st.session_state.is_button2_disabled = False
        progress_value = 25
        progress_text = "Pipeline progress = " + str(progress_value) + "%"
...
with col2:
    ...
    if st.button("Button 2", key="button2", disabled=st.session_state.is_button2_disabled):
        st.session_state.is_button2_disabled = True
        st.session_state.is_button3_disabled = False
        progress_value = 50
        progress_text = "Pipeline progress = " + str(progress_value) + "%"
...
with col3:
    ...
    if st.button("Button 3", key="button3", disabled=st.session_state.is_button3_disabled):
        st.session_state.is_button3_disabled = True
        st.session_state.is_button4_disabled = False
        progress_value = 75
        progress_text = "Pipeline progress = " + str(progress_value) + "%"
